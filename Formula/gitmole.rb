class Gitmole < Formula
  ...
  on_macos do
    on_arm do
      ...
      resource "tree-sitter-php" do
        url "https://files.pythonhosted.org/packages/90/74/965ecf806fab19eab474072a096f26e6c542821f3e72db887a1438c94273/tree_sitter_php-0.23.9-cp39-abi3-macosx_11_0_arm64.whl"
    ...
    on_intel do
      ...
      resource "tree-sitter-php" do
        url "https://files.pythonhosted.org/packages/c1/d3/85610fe9f228a4449a1c073ab9549e9eb9ffe2157e7ec5130f4d8c6b8a98/tree_sitter_php-0.23.9-cp39-abi3-macosx_10_9_x86_64.whl"
  ...
  on_linux do
    on_arm do
      ...
      resource "tree-sitter-php" do
        url "https://files.pythonhosted.org/packages/5f/85/861878e08c9c2c0de2b06bb97606809be29830d36e477f64b497b03cff7c/tree_sitter_php-0.23.9-cp39-abi3-manylinux_2_17_aarch64.manylinux2014_aarch64.whl"
    ...
    on_intel do
      ...
      resource "tree-sitter-php" do
        url "https://files.pythonhosted.org/packages/ff/d2/2e0cd7edd03f4a8037beb20ab2b1b517678f897d570744b4e922d0978047/tree_sitter_php-0.23.9-cp39-abi3-manylinux_2_17_x86_64.manylinux2014_x86_64.whl"
