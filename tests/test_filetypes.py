...
class DeepGeneratedMarkers(unittest.TestCase):
    ...
    def test_a_banner_a_script_writes_through_a_heredoc_is_the_scripts_output(self):
        self.assertFalse(filetypes.says_generated("#!/bin/sh\n# licence\n\n\nCOMMAND=x\n\ncat <<EOF\n// $COMMAND\n// MACHINE GENERATED BY THE ABOVE COMMAND; DO NOT EDIT\n"))
        self.assertFalse(filetypes.says_generated(self.LICENCE + "fragment <<'EOF'\n/* This file is generated by a shell script.  DO NOT EDIT! */\n"))
        self.assertTrue(filetypes.says_generated(self.LICENCE + "std::cout << name;\n/* A Bison parser, made by GNU Bison 3.7.4.  */\n"), "a C++ shift is not a heredoc")
